        ...
        <div className="">
          ...
          <div className="d-flex justify-content-around mt-3">
            <div>
              ...
              >
                <div className="circle nathan m-2"></div>
              </a>
            ...
            <div>
              <a
                ...
                rel="noopener noreferrer"
              >
                <div className="circle jason m-2"></div>
              </a>
            ...
            <div>
              <a
                ...
                rel="noopener noreferrer"
              >
                <div className="circle kushol m-2"></div>
              </a>
        ...
        <div className="mt-3 ml-5 pb-5">
          ...
          <div className="our-app ml-4 mt-5">
            ...
            <ul className="mont m-3">
              ...
              <li className="m-3">Add new tasks to any Column at any time!</li>
              <li className="m-3">
                Thanks to the work of our developers, our app gives your the ability drag columns to switch the order if
                needed and you can move tasks up and down within the column or horizontally to another column!
              </li>
            </ul>
          </div>
        </div>
