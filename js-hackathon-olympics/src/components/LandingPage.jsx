...
export default function Landing(props) {
    ...
    return(
      <div className="w-100 d-flex justify-content-center flex-wrap">
        <h1 className="d-flex justify-content-center flex-wrap">Get organized, and Stay ahead of the competition with our new Kanban Board!</h1>
        <div className='border greyBackground d-flex justify-content-center w-100'>
          <img src="./kanbanBoard.png" alt="kanban board" className='py-3 w-75'/>
        </div>
        <div className='d-flex justify-content-center flex-wrap'>
          <h2 className='w-100 d-flex justify-content-center'>What Our App has to Offer:</h2>
          <ul>
            <li>
        ...
        <div className='d-flex justify-content-center flex-wrap'>
          <h4 className='w-100'>So what are you waiting for, give our Kanban board a test drive by clicking the button below</h4>
